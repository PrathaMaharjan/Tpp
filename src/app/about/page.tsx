    ...
    <main className="min-h-screen bg-white font-sans">
          ...
          {storyHtml && (
            <div
              className="space-y-6 text-slate-600 text-base leading-relaxed font-normal
                ...
                [&_blockquote]:border-l-4 [&_blockquote]:border-[#4fa1b0] [&_blockquote]:bg-slate-50/70 [&_blockquote]:p-4 [&_blockquote]:rounded-r-xl [&_blockquote]:my-6
          ...
          <div className="max-w-5xl mx-auto px-6 grid md:grid-cols-2 gap-8">
            {aboutData.mission && (
              <div className="bg-white p-8 rounded-2xl shadow-xs border border-slate-200/70 hover:shadow-md transition-shadow">
                <div className="w-12 h-12 rounded-xl bg-[#eaf4f6] text-[#4fa1b0] flex items-center justify-center mb-5">
          ...
          <div className="max-w-5xl mx-auto px-6">
            ...
            <div className={`grid gap-6 ${aboutData.stats.length === 2 ? 'grid-cols-2 max-w-lg mx-auto' :
              ...
              {aboutData.stats.map((stat, idx) => (
                <div key={idx} className="text-center p-6 rounded-2xl bg-[#eaf4f6]/40 border border-[#4fa1b0]/15">
                  <div className="text-3xl sm:text-4xl font-extrabold text-[#3d838f] mb-1">
                    {stat.value}
                  </div>
      ...
      {aboutData?.features && aboutData.features.length > 0 && (
        <section className="py-14 bg-slate-50/70 border-t border-slate-100">
          <div className="max-w-5xl mx-auto px-6">
            <div className="text-center mb-10">
              <span className="text-xs font-semibold uppercase tracking-wider text-[#4fa1b0] block mb-1">
                What We Stand For
              </span>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {aboutData.features.map((feature, idx) => (
                <div key={idx} className="bg-white p-6 rounded-2xl border border-slate-200/80 shadow-xs hover:border-[#4fa1b0]/40 transition-colors">
                  <div className="w-9 h-9 rounded-lg bg-[#eaf4f6] text-[#4fa1b0] flex items-center justify-center mb-4">
